...
def get_version():
    version_filepath = os.path.join(os.path.dirname(__file__), 'drf_logger', 'version.py')
...
setup(
    ...
    license='MIT',
    keywords='django, djangorestframework, logging',
)
